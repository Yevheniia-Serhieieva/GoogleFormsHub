    ...
    api: import('@reduxjs/toolkit/query').CombinedState<
      {
        createForm: import('@reduxjs/toolkit/query').MutationDefinition<
          ...
          >,
          never,
          import('@shared/types').Form,
          'api',
          unknown
        >;
        getForms: import('@reduxjs/toolkit/query').QueryDefinition<
          void,
          import('@reduxjs/toolkit/query').BaseQueryFn<
            string | import('@reduxjs/toolkit/query').FetchArgs,
            unknown,
          ...
          unknown
        >;
        getForm: import('@reduxjs/toolkit/query').QueryDefinition<
          string,
          import('@reduxjs/toolkit/query').BaseQueryFn<
            string | import('@reduxjs/toolkit/query').FetchArgs,
            unknown,
        ...
        submitResponse: import('@reduxjs/toolkit/query').MutationDefinition<
          ...
          unknown
        >;
        getResponses: import('@reduxjs/toolkit/query').QueryDefinition<
          string,
          import('@reduxjs/toolkit/query').BaseQueryFn<
            string | import('@reduxjs/toolkit/query').FetchArgs,
            unknown,
